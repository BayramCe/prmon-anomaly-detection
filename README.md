...
- Helped with the workload script structure (`workload.sh`, `workload2.sh`). The anomaly types and parameter values were chosen by me, but the bash scripting was largely AI-assisted.
